...
```text
/skill:code-review [<numero de PR | URL de PR>] [--no-publish]
```

- Con número o URL: revisar ese PR.
- Sin número ni URL: intentar resolver el PR abierto de la branch actual con `gh pr view`. Si no hay uno inequívoco, pedir número o URL con `ask_user_question`.
