...
description: Sesión de $grill que además mantiene los docs del dominio (glosario CONTEXT.md y ADRs) a medida que las decisiones cristalizan. Usar solo cuando el usuario pida explícitamente grill con documentación de dominio.
---
...
Una sola pregunta que mezcle "¿confirmás el plan?" con "¿creo el ADR?" fuerza a decidir dos cosas de distinta naturaleza a la vez. Mantenelas aparte.
