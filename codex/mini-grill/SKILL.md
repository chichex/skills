---
name: mini-grill
description: Desambigua rápidamente un pedido y confirma que fue entendido antes de actuar. Usar SOLO cuando el usuario lo pide explícitamente: dice "mini grill", "mini grilling", "aclarame este prompt", "confirmame que entendiste". No invocar proactivamente ante pedidos ambiguos. Alinea brevemente alcance e intención sin una entrevista exhaustiva.
---
...
3. Si hay una ambigüedad relevante, hacé una sola pregunta por vez y ofrecé primero tu opción recomendada con una explicación breve. Cuando sea útil, ofrecé entre dos y cuatro opciones concretas. Usá `request_user_input` solo si está disponible; si no, preguntá en texto plano y terminá el turno.
...
6. Cuando ya no haya ambigüedades relevantes, presentá una interpretación final breve como mensaje visible en el chat y pedí confirmación antes de ejecutar o producir el resultado solicitado. La interpretación tiene que estar visible antes de abrir cualquier pregunta estructurada.
