...
Para grill/spec/quick-run usá `request_user_input`. La pregunta debe repetir en una oración el outcome de `En pocas palabras`, para que la decisión sea autocontenida, y ofrecer:
