...
Codex cuando trabaja solo. Hay dos perillas: si EJECUTO los comandos que encuentre
...
1. **AGENTS.md / Codex** — Codex usa `AGENTS.md` como instrucción de proyecto. Si `AGENTS.md` no contiene `.sdd/project.md`, agregar este bloque (o crearlo con el bloque):
