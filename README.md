...
| **`workflow-orchestrator`** | Consume `WorkflowResolutionV1`, materializa skills canónicos, administra receipts one-shot y abre sesiones hijas same/cross-project. También registra `/sdd-run` y el gate `launch_sdd_run`. |
