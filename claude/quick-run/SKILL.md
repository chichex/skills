...
- Invocación del harness: `/quick-run`.
- Productor del handoff: `/issue-triage`.
- Escalamiento seguro: `/grill` o `/sdd-spec`.
...
4. Si aparece una decisión nueva, una migración, seguridad, integración externa, expansión transversal o falta de verificación fiable, frená. No amplíes silenciosamente el quick-run; recomendá `/grill` o `/sdd-spec` con la evidencia encontrada.
